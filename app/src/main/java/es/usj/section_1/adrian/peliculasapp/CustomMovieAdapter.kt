...
class CustomMovieAdapter : ArrayAdapter<Movie> {
    ...
    constructor(context: Context, resourceId: Int, items: MutableList<Movie>) : super(
        context,
        resourceId,
        items
    ) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.text1.text = "  \uD83C\uDFAC  ${value!!.title}"
        holder.text2.text = " \uD83D\uDCC5  ${value!!.year}  "
        return view
    }
}